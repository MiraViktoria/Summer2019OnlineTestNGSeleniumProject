...
Thread.sleep(20000) let's say we put on pause our test  for 20 seconds. Even though element was available
after 3 seconds,
...
next is Explicit Wait ---> It works in similar way as an implicit wait, but explicit wait targets
...
wait until page is loaded handled automatically by selenium, but other conditions -
no (like visibility or clickability).
