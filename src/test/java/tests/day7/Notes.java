...
In both cases, if there is some miss match (should be true, but false; must be equals but not equals) test will step,
 and test will be marked as a failed. Also, in the console, you can see where it failed.
